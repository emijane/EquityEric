...
const AuthPage = () => {
   ...
   */
  return (
    <div className="AuthPage-container-outer pt-8 px-8 bg-white w-[100vw] h-auto flex flex-row overflow-y-auto">
        ...
        <div className="auth-component-sign-up mt-10 xs:min-w-sm md:min-w-md w-5/6 md:w-3/4">
          <div className="auth-component-header">
            <div className="hidden md:flex flex-col gap-y-1 auth-component-header-large">
              ...
              <p className="text-cleargray text-sm">Create your account now</p>
            ...
            <div className="md:hidden auth-component-header-small mt-2 flex flex-col gap-y-2 items-center">
              ...
              <p className="text-cleargray text-sm text-center">Create your account to get the answers you deserve about your healthcare policy.</p>
            </div>
          </div>
        </div>
      </div>
